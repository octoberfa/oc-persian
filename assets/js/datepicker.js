    ...
    DatePicker.prototype.initDatePicker = function () {
        ...
        var pikadayOptions = {
            ...
            onSelect: function (selectedDay) {
                let m = moment(selectedDay)
                self.onSelectDatePicker.call(self, m)
            }
        }
        ...
        // }
        var dp = this.$datePicker.pDatepicker(pikadayOptions)
        // setTimeout(() => {
        //     dp.setDate(this.getDataLockerValue('x'))
        //     dp.setDate(this.getDataLockerValue('x'))
